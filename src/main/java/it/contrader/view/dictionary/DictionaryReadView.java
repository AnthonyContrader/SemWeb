 ...
 */
public class DictionaryReadView extends AbstractView {

	private int id;
	private Request request;
	private final String mode = "READ";

	public DictionaryReadView() {
	}
	...
	public void showResults(Request request) {
		if (request != null) {
			DictionaryDTO dictionary = (DictionaryDTO) request.get("dictionary");
	...
	public void showOptions() {
		System.out.println("Inserisci l'ID del dizionario:");
