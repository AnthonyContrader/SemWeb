...
public class HomeAdminView extends AbstractView {
    ...
    public void showResults(Request request) {
    	if(request!=null) {
    	System.out.println("\n Benvenuto in SemWeb "+request.get("username").toString() + "\n");
    	}
    }
    ...
    public void showOptions() {
        ...
        System.out.println("[U]tenti  [R]icerche  [D]izionari [T]opics [E]sci");
    ...
    public void submit() {    
        ...
        case "r":
        	this.request.put("mode", "RESEARCHLIST");
        	MainDispatcher.getInstance().callAction("Research", "doControl", request);
        	break;
        	
        case "d":
        	this.request.put("mode", "DICTIONARYLIST");
        	MainDispatcher.getInstance().callAction("Dictionary", "doControl", request);
        	break;
        	
        case "t":
        	this.request.put("mode", "TOPICLIST");
        	MainDispatcher.getInstance().callAction("Topic", "doControl", request);
        	break;
        default:
